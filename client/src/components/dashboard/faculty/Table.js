...
const Table = ({ course, date, index, record: { roll, name, year }, markAttendance }) => {
    console.log(index);
    ...
    return (
        ...
        <tr>
            ...
            <td style={{ fontWeight: "700", fontSize: "36" }}><Link to={`/faculty/attendance/${course}/${roll}/${year}`}>{roll}</Link></td>
