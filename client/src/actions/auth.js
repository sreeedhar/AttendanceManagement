...
export const loadParent = () => async dispatch => {
    ...
    try {
        const res = await axios.get('/api/parent/current');
...
// Register student
export const studentRegister = ({ email, password, roll, name, dept, year }) => async dispatch => {
    const config = {
        headers: {
...
// Register faculty
export const facultyRegister = ({ email, password, name, dept }) => async dispatch => {
    const config = {
        headers: {
            'Content-Type': 'application/json'
        }
...
export const loginParent = (email, password) => async dispatch => {
    ...
    try {
        const res = await axios.post('/api/parent/login', body, config);
